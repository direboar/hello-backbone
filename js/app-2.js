...
test("コレクションの基本", function () {
    ...
    //要素の追加
    myModelCollection.add({name : 'hasegawa'});
    ...
    deepEqual(myModelIndex2.attributes,{name : 'index::2'});
    equal(myModelCollection.size(),7);

    //検索。属性が指定した値のオブジェクトの配列を取得。コレクションではなく配列が戻ってくるらしい
    var find = myModelCollection.where({name : 'index::2'});
    equal(true,find instanceof Array);
    equal(1,find.length);
    deepEqual(find[0].attributes,{name : 'index::2'});
    ...
    //削除されていることの確認
    find = myModelCollection.where({name : 'index::2'});
    equal(find.length,0);
    ...
    deepEqual(myModelCollection.at(0).attributes,{name : 'foo'});
    deepEqual(myModelCollection.at(1).attributes,{name : 'bar'});
    deepEqual(myModelCollection.at(2).attributes,{name : 'baz'});
    ...
    deepEqual(sortedMyCollection.at(0).attributes,{name : 'anonimous',age :10});
    deepEqual(sortedMyCollection.at(1).attributes,{name : 'takao' ,age : 30});
    deepEqual(sortedMyCollection.at(2).attributes,{name : 'eiji' ,age : 40});
    ...
    deepEqual(sortedMyCollection.at(1).attributes,{name : 'takao' ,age : 30});
    deepEqual(sortedMyCollection.at(2).attributes,{name : 'eiji' ,age : 40});
    deepEqual(sortedMyCollection.at(3).attributes,{name : 'abcdef' ,age : 100});

    //sortを呼ぶと、Collection#comparatorによりソートされる。
    sortedMyCollection.sort();
    deepEqual(sortedMyCollection.at(0).attributes,{name : 'eiji' ,age : 40});
    deepEqual(sortedMyCollection.at(1).attributes,{name : 'takao' ,age : 30});
    deepEqual(sortedMyCollection.at(2).attributes,{name : 'abcdef' ,age : 100});
    deepEqual(sortedMyCollection.at(3).attributes,{name : 'anonimous',age :10});
    ...
    deepEqual(filtered[0].attributes,{name : 'eiji' ,age : 40});
    deepEqual(filtered[1].attributes,{name : 'abcdef' ,age : 100});

    //slice
    var silecd = sortedMyCollection.slice(1,3); //index1 以上　3未満を取得。
    equal(silecd.length,2)
    deepEqual(silecd[0].attributes,{name : 'takao' ,age : 30});
    deepEqual(silecd[1].attributes,{name : 'abcdef' ,age : 100});
    ...
    deepEqual(myModelCollection.get('A').attributes,{id : 'A',name : "name1"});
    deepEqual(myModelCollection.get('B').attributes,{id : 'B',name : "name2"});
    deepEqual(myModelCollection.get('C').attributes,{id : 'C',name : "name3"});
...
test("コレクションのREST対応", function () {
    ...
    myCollection.fetch(
        {
            ...
            success : function(collection, response, options){
                ...
                ok(collection.at(0).matches({id : 1}));
                ok(collection.at(1).matches({id : 2}));
                ok(collection.at(2).matches({id : 3}));
            },
    ...
    myCollection.create(
        {name : "nameX"},
        {
            ...
            success : function(object, response, options){
                deepEqual(object.attributes,{id :4,name : 'nameX'});
            },
    ...
    deepEqual(myCollection.at(0).attributes,{id :1,name : 'name1'});
    deepEqual(myCollection.at(1).attributes,{id :2,name : 'name2'});
    deepEqual(myCollection.at(2).attributes,{id :3,name : 'name3'});
    deepEqual(myCollection.at(3).attributes,{id :4,name : 'nameX'});
